  ...
  return (
    <>
      <PageHeader
        ...
        image={{ src: productImages.route, alt: "Distribution agroalimentaire MSM" }}
      />
      ...
      <section className="border-y border-msm-border bg-white py-16 sm:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <ImageFeature
            ...
            alt="Livraison et distribution sur route dans les régions éloignées"
          >
      ...
      <section className="border-t border-msm-border py-16 sm:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <ImageFeature
            src={productImages.comptoir}
            alt="Point de vente et facturation agroalimentaire"
            reverse
          >
